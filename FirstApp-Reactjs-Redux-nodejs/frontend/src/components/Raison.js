...
const AddRaison = ({Post, isLoading})=>{    
    ...
    return(
            ...
            <Card >
                <Link to={`/reasons/${raison._id}`} >
                    <CardImg  src={Url+raison.img} alt={raison.img}/>
                    <CardBody>
...
const Raison = (props)=>{
    console.log("Map: " + props.raisons.raisons);
    const menu = props.raisons.raisons.map((rai)=>{   
            return(
