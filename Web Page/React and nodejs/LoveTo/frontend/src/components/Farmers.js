...
const Farmers = (props)=>{
  const Slice = ()=>props.Farmers.slice((Pag-1)*maxElement , Pag*maxElement)
  var [Pag, setPag] = useState(1);
  var maxElement = 6;
  var maxPag = Math.ceil(props.Farmers.length / maxElement);
  var [Show, setShow] = useState(Slice());
   

      const farmer = Show.map((farmer)=>{
        ...
        return(
          ...
          <Row className="form-group text-muted text-center">
              ...
              <Col md={3} sm={3}>
                <Status status={farmer.Banned} />

              </Col>
              <Col md={3} sm={3}>
                <label class="switch ">
                    <input type="checkbox" checked={!farmer.Banned} model=".active" onChange={()=>{props.Put(farmer._id,!farmer.Banned,"farmer","coorp");}} />
      ...
      return(
        <div>
            ...
            <div className=" col-12 m-auto border shadow py-3 px-1 text-left animated backInLeft" style={{borderRadius:"10px",minHeight:"481px"}}>
              <div className="col-11 mx-auto mb-3 mt-1">
                  <div className="h5 col-11" > <strong>Farmers Management</strong></div>
                  <hr/>
                <div className="mt-1">

                  <Row className="form-group mb-4 text-center ">
                    <Col md={3} sm={3}>
                      <p className="h6"><strong>Farmers</strong></p>                    
                    </Col>
                    <Col md={3} sm={3}>
