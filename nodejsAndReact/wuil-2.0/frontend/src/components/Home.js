...
const Jumbo = () => {
    return (
      <div>
        <Jumbotron  fluid className="bg-muted text-info animated pulse ">
...
const Carou = ({items})=>{
    ...
    return(
      <div  className=" row col-12 col-mt-9 m-auto animated bounce">
...
const Home = (props)=>{
    const items = [
        {
            src:  "images/carousel/carousel_1.jpeg",
            altText: 'Slide 1',
            caption: ''
          },
          {
            src:  "images/carousel/carousel_2.jpeg",            
            altText: 'Slide 2',
            caption: ''
           
          },
          {
            src:  "images/carousel/carousel_3.jpeg",            
            altText: 'Slide 3',
            caption: ''
          },
          {
            src:  "images/carousel/carousel_4.jpeg",
            altText: 'Slide 4',
            caption: ''
          },
          {
            src:  "images/carousel/carousel_5.jpeg",            
            altText: 'Slide 5',
            caption: ''
           
          },
          {
            src:  "images/carousel/carousel_6.jpeg",            
            altText: 'Slide 6',
            caption: ''
          }
    ...
    return(
      <div>
        ...
        <div className="container mt-5 mb-5">     
            <Carou items={items}/>
            <hr/>
            <div className="row text-justify mt-3 animated bounce" >
